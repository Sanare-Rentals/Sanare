function openModal(title, image, description) {
    ...
    if (title === "Sanare 1") {
        ...
        modalImage = "Images/Pop3.jpg";
        modalDescription = "Perfect for Families! (good for 6-8 persons)\n\n" +
                           "Rate: 4000/night\n" +
                           "Check-in time: 2:00 pm\n" +
                           "Check-out time: 12:00 pm\n" +
                           "- Reservation basis -";
    } else if (title === "Sanare 4") {
        modalImage = "Images/Pop4.jpg";
        modalDescription = "Perfect for Families and Friends! (good for 6-8 persons)\n\n" +
                           "Rate: 5000/night\n" +
                           "Check-in time: 2:00 pm\n" +
                           "Check-out time: 12:00 pm\n" +
                           "- Reservation basis -";
